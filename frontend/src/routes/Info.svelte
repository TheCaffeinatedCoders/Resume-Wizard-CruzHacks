<script>
    ...
    async function getAISuggestion(target) {
...
<div id="container">
    ...
    {:else if currentSection === "objective"}
        <div>
            ...
            <input
                id="objective"
                bind:value={currentSectionData[0].objective}
            />
        </div>
        <button class="button AIbutton" on:click={getAISuggestion(currentSectionData[0].objective)}
            >AI touch up</button
        >
        {#if currentAISuggestion}
            <button
                on:click={() =>
                    (currentSectionData[0].objective =
                        currentAISuggestion)}>{currentAISuggestion}</button
            >
        {/if}
    {:else if currentSection === "education"}
        ...
        <div>
            ...
            <input
                id="schoolName"
                bind:value={currentSectionData[0].schoolName}
            />
        </div>
        <div>
        ...
        <div>
            ...
            <input
                ...
                bind:value={currentSectionData[0].school_description}
            />
        </div>
        <div>
            ...
            <input
                ...
                bind:value={currentSectionData[0].school_start_date}
            />
        </div>
        <div>
            ...
            <input
                id="school_end_date"
                bind:value={currentSectionData[0].school_end_date}
            />
        </div>
        <button class="button AIbutton" on:click={getAISuggestion(currentSectionData[0].school_description)}
            >AI touch up</button
        >
        {#if currentAISuggestion}
            <button
                on:click={() =>
                    (currentSectionData[0].school_description =
                        currentAISuggestion)}>{currentAISuggestion}</button
            >
        {/if}
    {:else if currentSection === "employment"}
        ...
        <div>
            ...
            <input
                id="companyName"
                bind:value={currentSectionData[0].companyName}
            />
        </div>
        <div>
            ...
            <input
                id="company_city"
                bind:value={currentSectionData[0].company_city}
            />
        </div>
        <div>
        ...
        <div>
            ...
            <input
                id="job_start_date"
                bind:value={currentSectionData[0].job_start_date}
            />
        </div>
        <div>
            ...
            <input
                id="job_end_date"
                bind:value={currentSectionData[0].job_end_date}
            />
        </div>
        <div>
            ...
            <input
                id="job_description"
                bind:value={currentSectionData[0].job_description}
            />
        </div>
        <button class="button AIbutton" on:click={getAISuggestion(currentSectionData[0].job_description)}
            >AI touch up</button
        >
        {#if currentAISuggestion}
            {#if currentAISuggestion}
                <button
                    on:click={() =>
                        (currentSectionData[0].job_description =
                            currentAISuggestion)}>{currentAISuggestion}</button
                >
            {/if}
        {/if}
    {:else if currentSection === "projects"}
        ...
        <div>
            ...
            <input
                id="project_name"
                bind:value={currentSectionData[0].project_name}
            />
        </div>
        <div>
            ...
            <input
                ...
                bind:value={currentSectionData[0].project_start_date}
            />
        </div>
        <div>
            ...
            <input
                id="project_end_date"
                bind:value={currentSectionData[0].project_end_date}
            />
        </div>
        <div>
            ...
            <input
                ...
                bind:value={currentSectionData[0].project_description}
            />
        </div>
        <button class="button AIbutton" on:click={getAISuggestion(currentSectionData[0].project_description)}
            >AI touch up</button
        >
        {#if currentAISuggestion}
            <button
                on:click={() =>
                    (currentSectionData[0].project_description =
                        currentAISuggestion)}>{currentAISuggestion}</button
            >
        {/if}
    {:else if currentSection === "skills"}
        ...
        <div>
            ...
            <input
                id="skill_name"
                bind:value={currentSectionData[0].skill_name}
            />
        </div>
        <div>
            ...
            <input
                ...
                bind:value={currentSectionData[0].skill_description}
            />
        </div>
        <button class="button AIbutton" on:click={getAISuggestion(currentSectionData[0].skill_description)}
            >AI touch up</button
        >
        {#if currentAISuggestion}
            <button
                on:click={() =>
                    (currentSectionData[0].skill_description =
                        currentAISuggestion)}>{currentAISuggestion}</button
            >
        {/if}
    {/if}
